...
def cal_image_level(model, dataset_dir,save_result=False):
    file_list = os.path.join(dataset_dir, '/home/aistudio/dataset/test_list.txt')
    threshold = 0.4
    # threshold = 0.5
    matrix = [[0,0],[0,0]]
    fire_to_no = []
...
if __name__ == '__main__':
    # 待测试图片路径
    dataset_dir = '/home/aistudio/dataset/eval_imgs'
    # 模型路径
    model_dirs = '/home/aistudio/code/output/ppyolov2_r50vd_dcn/'
